...
/**
 * A driver class that runs an old school text/console based Role Playing Game.
 * 
 * @author Andrew A. Krupp
 *
 */
// I'm not sure why I'm getting a style error here, there is an empty line preceding all
// @author, @param, and @return in this program.
public class Main {
  /**
   * This is the main method, it is where the program starts running code.
   * 
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Below is a series of examples demonstrating my knowledge of things I could not naturally "
            + "fit into my program at this point \n" + operatorExample);
    operatorExample++;
    ...
    int numberOfQuizScores = 1;
    boolean arrayLengthValidation = true;
    do {
      try {
        System.out.println("Enter an integer.");
        numberOfQuizScores = scan.nextInt();
        arrayLengthValidation = false;
      } catch (Exception e) {
        System.out.println("Invalid input. Please enter an integer.");
      }
    } while (arrayLengthValidation == true);
    ...
    System.out
        .println("The smallest score is " + smallestScore + " at Index " + smallestScoreIndex);
    ...
    System.out.println("The value 9 was found at row " + positionOfValueRow + ", column "
        + positionOfValueCol + ".");
  ...
  /**
   * This is the menu method, it allows the user to move through the program by selecting which
   * parts of the program they wish to interact with.
   */
  public static void menu() {
    Scanner scan = new Scanner(System.in);

    System.out.println("For a better experience, please answer the question below: "
    ...
    switch (viewingReason) {
      ...
      case "no":
        System.out
            .println("Then you must either be my professor or looking to recruit me for a job. "
                + "\nWelcome! I have many comments in the code of this program to show "
                + "my knowledge of Java. Email me at aakrupp1968@my.fgcu.edu "
    ...
    System.out.println(
        "Welcome to my Java Text-Based RPG \nTo proceed with Character Creation: press 1 \n"
            + "To skip Character Creation and proceed directly to Act 1 of the story: "
            + "press 2 (You will be provided a pre-built character)"
    ...
    do {
      try {
        ...
        if (userSelection == 1) {
          ...
          menuValidation = true;
        } else if (userSelection == (int) 420.0) { // super useless example of casting, but
          // nonetheless it shows how it works by casting the double to an int for the purpose of
          // testing the input
  ...
  /**
   * This method is where the user will interact with the PlayerCharacter class to create their own
   * personal character.
   */
  public static void characterCreation() {
    ...
    do {
      try {
        System.out.println("Hello and welcome to my game! This is RPG quest (placeholder title). "
            + "An RPG Sci-fi Adventure game. Enter your name to continue: ");
        ...
        /*
         * I'm not sure why I'm getting this style error. All caps with underscores is the
         * convention google asks for.
         */
        ...
        System.out.println("Would your like your character to be human or some other race? "
            + "(enter true for human, false for another fictional race");
        ...
        while (intellectSelectionCondition == false) {
          ...
          if (playerIntellectSelection > 0 && playerIntellectSelection <= 10
            ...
            System.out.println("Invalid Entry. You can put a maximum of 10 points into a skill, "
                + "and you have 12 points to start with. "
                + "\nPlease ensure your entry meets these constraints. ");
          }
        }

        System.out.println("Select the skill level for Strength. This will effect "
            + PLAYER_CHARACTER_NAME + "'s ability to solve problems with brute force");
        ...
        System.out.println("Select the skill level for Engineering. This will effect "
            + PLAYER_CHARACTER_NAME + "'s ability to solve problems with mechanical skill");
        ...
        scanner.nextLine();
        System.out.println("Incorrect Entry. Restarting Character Creation...");
        // I know this is super lazy, I will refine it later when I'm not under a time constraint
      } catch (Exception e) {
  ...
  /**
   * This is where the actual story and gameplay of the game begins.
   * 
   * @param characterUserChose the character created by the PlayerCharacter class
   * 
   */
...
/*
 * A collection of skills I learned in COP 2006 for the Java programming language For this project,
 * I will be creating a text based Role PLaying Game Think Dungeons and Dragons, but in a different
 * setting and played by yourself. In this situation, I am your dungeon master. Enjoy the game!
 */

/*
 * >int: 32-bit data type for integers up to a value of around 2.2 billion
 * 
 * >byte: 8-bit data type useful for saving memory in large arrays with a min value of -128 and a
 * max of 127
 * 
 * >short: 16-bit data type also useful for saving memory in large arrays but with a min value of
 * -32,768 and a max of 32,767
 * 
 * >long: a 64-bit data type with a very, very large max value that is useful when the desired value
 * is outside of the int data types range
 * 
 ...
 */
/*
 * Operator Precedence (from top to bottom): Postfix(++, --) Unary Multiplicative Additive Shift
 * Relational Equality Bitwise AND Bitwise OR Logical AND Logical OR Ternary Assignment
 */
// == is the equals operator
// With strings, the == compares the memory addresses rather than the actual strings themselves.
// Thus, the == operator does not work with Strings.
// A variable is a location in memory

// Scope is when a variable is only accessible in the method it was created (defined)
/*
 * Inheritance: In Java, classes can be derived from other classes Subclass: a class derived from
 * another class Superclass: the class from which the subclass is derived from Allows for the reuse
 * of already written code without the need to rewrite and re-debug said code
 */

/*
 * Polymorphism: subclasses can define their own unique behaviors and yet share some of the same
 * functionality as their parent class
 */
